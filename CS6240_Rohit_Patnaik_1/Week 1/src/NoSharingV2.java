...
class NoSharingThreadV2 extends Thread{
	...
	public NoSharingThreadV2(List<String> res,Map<String, List<Double>> map){
		this.res = res;
		this.hm = map;
	}
	
	public NoSharingThreadV2(){
...
public class NoSharingV2 extends Loader{
	...
	public static void main(String[] args) {
		...
		NoSharingThreadV2 td1 = new NoSharingThreadV2(res.subList(0, inputLength/2),hm1);
		NoSharingThreadV2 td2 = new NoSharingThreadV2(res.subList(inputLength/2, inputLength), hm2);
